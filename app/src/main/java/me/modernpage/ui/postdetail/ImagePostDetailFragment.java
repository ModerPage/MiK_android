...
@AndroidEntryPoint
public class ImagePostDetailFragment extends BaseFragment<PostDetailViewModel, LayoutPostImageViewBinding> {
    ...
    public int getLayoutRes() {
        return R.layout.layout_post_image_view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mImagePopUpHelper.enablePopUpOnClick(getActivity(), dataBinding.postViewImage, post.getPost()._file());
    }
}
